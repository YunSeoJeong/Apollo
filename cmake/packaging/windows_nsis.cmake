...
SET(CPACK_NSIS_EXTRA_INSTALL_COMMANDS
        ...
        nsExec::ExecToLog \
          'powershell.exe -NoProfile -ExecutionPolicy Bypass -File \\\"$INSTDIR\\\\scripts\\\\install-vdd.ps1\\\"'
...
set(CPACK_NSIS_EXTRA_UNINSTALL_COMMANDS
        ...
        NoGamepad:
        MessageBox MB_YESNO|MB_ICONQUESTION \
            'Do you want to remove vdVDD Virtual Display Driver?' \
            /SD IDNO IDNO NoVDD
            nsExec::ExecToLog \
              'powershell.exe -NoProfile -ExecutionPolicy Bypass -File \
                \\\"$INSTDIR\\\\scripts\\\\uninstall-vdd.ps1\\\"'; \
              skipped if no
        NoVDD:
        MessageBox MB_YESNO|MB_ICONQUESTION \
